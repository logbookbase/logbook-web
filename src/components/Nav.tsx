  ...
  return (
    <nav className="sticky top-0 z-10 flex items-center justify-between border-b border-line bg-bg/85 px-8 py-5 backdrop-blur">
      ...
      <div className="flex items-center gap-3">
        <Link
          href="/docs"
          className="hidden rounded-md border border-lineStrong bg-white px-4 py-2 text-sm font-medium transition-colors hover:border-muted sm:inline-flex"
        >
          Read docs
        </Link>
        <Link
          href="/docs#quickstart"
          className="inline-flex items-center gap-2 rounded-md bg-accent px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-accentHover"
        >
          Start logging →
        </Link>
      </div>
